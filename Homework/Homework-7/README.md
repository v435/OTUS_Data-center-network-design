...
EVPN instance: VLAN 10
  ...
  Local ethernet segment:
    ...
    ESI: 0000:0000:0000:0000:0001
      ...
      Non-Designated forwarder: 10.1.1.2
```
Что нам тут важно увидеть: 1) локальные Ethernet-сегменты и кто является для них Designated Forwader'ом, а кто не является таковым. Также можем убедиться, что у нас включен режим All-Active, оба линка к клиенту могут использоваться одновременно.

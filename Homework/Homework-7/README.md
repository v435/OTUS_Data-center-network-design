...
1) Сервер MAC1, находящийся за VTEP-1, а также находящийся в одном VNI с клиентским коммутатором "L2 CE Switch" за VTEP-2 и VTEP-3, создает некий BUM-пакет и отправляет его в свой L2-домен.

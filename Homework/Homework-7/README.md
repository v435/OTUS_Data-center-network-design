...
```
Помимо перевода интерфейса в режим VLAN 10 Untagged, мы здесь задаем MAC-адрес LACP-канала. Он должен быть одинаковым на обоих Leaf'ах-ногах Port-Channel'а, чтобы клиент считал оба линка ведущими к одному устройству (он ведь ничего не знает ни про какие ESI LAG, для него канал выглядит как два линка к одному физическому устройству).

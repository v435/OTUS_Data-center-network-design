...
1) Сервер MAC1, находящийся за VTEP-1, находящийся в одном VN-сегменте с клиентским коммутатором за VTEP-2 и VTEP-3, создает некий BUM-пакет и отправляет его в свой L2-домен.

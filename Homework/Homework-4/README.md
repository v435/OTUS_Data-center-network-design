...
<!-- TOC --><a name="-leaf-1"></a>
### Настройка Leaf-1
Здесь есть небольшие различия от настройки Spine-ов. Во-первых, так как AS Spine'ов у нас одна, то и фильтрационный список мы указывать не будем, а явно зададим "remote-as 65100". Во-вторых локальная AS для каждого Leaf у нас уникальна. Нет настройки allowed-as. В остальном все то же самое, если не считать мелочи, вроде описаний интерфейсов и количества аплинков.

...
![MH_ping](attachments/mh_ping_cl1_4.drawio.png)

Отключим eth0:
![MH_eth0_down](attachments/mh_eth0_down.png)
...
```
Идет!
Путь трафика изменился на такой:
![MH_ping_eth1](attachments/mh_ping_cl1_4_eth0_down.drawio.png)
